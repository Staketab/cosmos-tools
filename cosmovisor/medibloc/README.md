...
&& ./cosmovisor.sh v0.42.9 medibloc panacea-core panacead panacead v2.0.1
```

## 3. Data for start the chain. 
Chain-id - `panacea-3`  
Genesis file - [Link](https://raw.githubusercontent.com/Staketab/cosmos-tools/main/cosmovisor/medibloc/genesis.json)  
...
Restart Cosmovisor service - `systemctl restart medibloc.service`  
Cosmovisor service logs - `journalctl -u medibloc.service -f`  
Stop Cosmovisor service - `systemctl stop medibloc.service`  
