...
elif [[ "${BIN_NAME}" == "sentinelhub-2" ]]; then
    cd $HOME/.${CONFIG_FOLDER}/data
...
elif [[ "${BIN_NAME}" == "desmos-mainnet" ]]; then
    cd $HOME/.${CONFIG_FOLDER}/data
...
elif [[ "${BIN_NAME}" == "impacthub-3" ]]; then
    cd $HOME/.${CONFIG_FOLDER}/data
